    ...
    extend: {
      colors: {
        ...
        'admin': {
          ...
          'bg-card': 'rgb(var(--admin-bg-card) / <alpha-value>)',
          'bg-sidebar': 'rgb(var(--admin-bg-sidebar) / <alpha-value>)',
          'bg-hover': 'rgb(var(--admin-bg-hover) / <alpha-value>)',
          'accent': 'rgb(var(--admin-accent) / <alpha-value>)',
          'accent-hover': 'rgb(var(--admin-accent-hover) / <alpha-value>)',
          'accent-secondary': 'rgb(var(--admin-accent-secondary) / <alpha-value>)',
