    ...
    <div className="w-full animate-scale-in">
      ...
      <div className="bg-white/10 dark:bg-slate-900/40 backdrop-blur-2xl p-8 md:p-10 rounded-3xl shadow-2xl border border-white/20 dark:border-slate-700/50 mt-12 mb-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {duplicateError && (
            <div className="p-4 rounded-2xl bg-amber-500/10 border border-amber-500/30 text-sm backdrop-blur-md">
              <p className="text-amber-400 font-semibold mb-1 flex items-center gap-2">
                <span className="material-symbols-outlined text-[18px]">error</span>
                Akun Sudah Terdaftar
              </p>
              <p className="text-slate-300 text-xs mb-3">{duplicateError}</p>
              <Link to="/login" className="inline-flex items-center gap-1 text-sm font-bold text-amber-400 hover:text-amber-300 hover:underline transition-colors">
