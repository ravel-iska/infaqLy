...
function FloatingWA() {
  ...
  return (
    ...
    >
      {/* Tooltip */}
      <div className="absolute right-full mr-4 bg-surface-container-lowest text-on-surface text-xs font-bold px-4 py-2 rounded-xl shadow-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap border border-slate-100">
        Pusat Bantuan
      </div>
