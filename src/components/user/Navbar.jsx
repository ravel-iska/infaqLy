          ...
          {isAuthenticated ? (
            <div className="relative" ref={dropdownRef}>
              ...
              >
                ...
                <span className={`material-symbols-outlined text-[16px] text-slate-500 dark:text-slate-400 transition-transform ${dropdownOpen ? 'rotate-180' : ''}`}>expand_more</span>
              </button>
          ...
          <div className="px-4 py-3 space-y-1">
            ...
            {isAuthenticated ? (
              <>
                ...
                >
                  <span className="material-symbols-outlined text-[16px]">person</span> Profil Saya
                </Link>
                <button
